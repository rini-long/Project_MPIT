...
theta_max = 25 * np.pi  # Максимальный угол (25π для большого количества витков)
...
# Цвета для "дочек"
colors = ['yellow', 'DarkMagenta', 'white','MediumBlue','OrangeRed']

# Функция для рисования одной спирали
def draw_spiral(offset_x, offset_y, start_point=0):
    ...
    for i in range(1, num_points):
        ...
        if random.random() < 0.09 and i > start_point:  # Вероятность 9% на каждой точке
...
for offset in offsets:
    draw_spiral(offset[0], offset[1], start_point=500)
